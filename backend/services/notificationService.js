...
class NotificationService {
  ...
  static async createNotification(userId, type, title, message, priority = 'medium', relatedId = null) {
    try {
      console.log('Saving notification:', { userId, type, title, message, priority, relatedId }); // Debug log
  ...
  static async notifyBookingStatusChange(booking, oldStatus, newStatus, guestId, propertyOwnerId) {
    const propertyTitle = booking.listing?.title || 'your property';
  ...
  static async notifyPaymentReceived(booking, amount, guestId, propertyOwnerId) {
    const propertyTitle = booking.listing?.title || 'your property';
