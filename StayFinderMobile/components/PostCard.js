      ...
      <View style={styles.info}>
        <View style={styles.rowBetween}>
          ...
          <View style={styles.ratingBox}>
            <Feather name="star" size={getResponsiveSize(12, 14, 16, 18)} color={COLORS.primary} />
        ...
        {amenities && (
          <View style={styles.amenitiesRow}>
            {amenities.wifi && <Feather name="wifi" size={getResponsiveSize(12, 14, 16, 18)} color={COLORS.textMuted} />}
            {amenities.kitchen && <Feather name="coffee" size={getResponsiveSize(12, 14, 16, 18)} color={COLORS.textMuted} />}
            {amenities.parking && <Feather name="car" size={getResponsiveSize(12, 14, 16, 18)} color={COLORS.textMuted} />}
            {amenities.tv && <Feather name="tv" size={getResponsiveSize(12, 14, 16, 18)} color={COLORS.textMuted} />}
          </View>
        )}
        
        <View style={styles.capacityRow}>
          <View style={styles.capItem}>
            <Feather name="users" size={getResponsiveSize(12, 14, 16, 18)} color={COLORS.textMuted} />
            <Text style={styles.capText}>{guests} guests</Text>
          </View>
          <View style={styles.capItem}>
            <Feather name="home" size={getResponsiveSize(12, 14, 16, 18)} color={COLORS.textMuted} />
            <Text style={styles.capText}>{bedrooms} bed</Text>
          </View>
          <View style={styles.capItem}>
            <Feather name="droplet" size={getResponsiveSize(12, 14, 16, 18)} color={COLORS.textMuted} />
