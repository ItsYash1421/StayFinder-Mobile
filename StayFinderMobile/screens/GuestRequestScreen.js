              ...
              {approvedRequests.map((req) => {
                ...
                return (
                  <TouchableOpacity
                    key={req._id}
                    activeOpacity={0.92}
                    style={{ marginBottom: 18, transform: [{ scale: 1 }], shadowColor: '#22c55e', shadowOpacity: 0.10, shadowRadius: 16, elevation: 6 }}
                  >
                    <LinearGradient
                      colors={["#f0fdf4", "#dcfce7"]}
                      start={{ x: 0, y: 0 }}
                      end={{ x: 1, y: 1 }}
                      style={[styles.requestCard, styles.floatingCard, { borderLeftWidth: 4, borderLeftColor: statusColor.bg, borderColor: '#d1fae5', backgroundColor: '#f8fafc' }]}
                    >
                      <Image
              ...
              {pendingRequests.map((req) => {
                ...
                return (
                  <TouchableOpacity
                    key={req._id}
                    activeOpacity={0.92}
                    style={{ marginBottom: 18, transform: [{ scale: 1 }], shadowColor: '#fbbf24', shadowOpacity: 0.10, shadowRadius: 16, elevation: 6 }}
                  >
                    <LinearGradient
                      colors={["#fefce8", "#fef9c3"]}
                      start={{ x: 0, y: 0 }}
                      end={{ x: 1, y: 1 }}
                      style={[styles.requestCard, styles.floatingCard, { borderLeftWidth: 4, borderLeftColor: statusColor.bg, borderColor: '#fde68a', backgroundColor: '#fefce8' }]}
                    >
                      <Image
                        source={{ uri: req.listing?.images?.[0] || 'https://via.placeholder.com/300x200?text=Property' }}
                        style={styles.requestImageRounded}
