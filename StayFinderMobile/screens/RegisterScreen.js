            ...
            <View style={styles.inputContainer}>
              ...
              <View style={styles.roleRow}>
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                >
                  <Feather name="user" size={16} color={formData.role === 'user' ? COLORS.primary : COLORS.textMuted} />
                  <Text style={[styles.roleText, formData.role === 'user' && styles.roleTextSelected]}>User</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.roleOption, formData.role === 'host' && styles.roleOptionSelected]}
                  onPress={() => handleChange('role', 'host')}
                  activeOpacity={0.8}
                >
                  <Feather name="home" size={16} color={formData.role === 'host' ? COLORS.primary : COLORS.textMuted} />
                  <Text style={[styles.roleText, formData.role === 'host' && styles.roleTextSelected]}>Host</Text>
                </TouchableOpacity>
              </View>
            </View>
            {/* Submit Button */}
